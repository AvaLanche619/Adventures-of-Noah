...
///*
  if (chap1Page === 0) {
    ...
    if (chap1Page === 1) {
      ...
      if (frameCount % 30 == 0) {
        ...
        text("Yum.", width/3.95, height/1.66)
        ...
        if (timer > 15 && timer < 24) {
          bigtext()
          text("You wake up in your bedroom to \nthe sound of an alarm clock.", width/3.95, height/1.66)
        }

        if (timer > 18 && timer < 24) {
          text("You’re tired from last night’s \npasta-eating frenzy.", width/3.95, height/1.4)
        }

        if (timer > 21 && timer < 24) {
          text("You remember it’s your first \nday working at Panda.", width/3.95, height/1.2)
        }

        if (timer > 24) {
          bigtext()
          text("Hit snooze?", width/3.95, height/1.66)
        }
  ...
  if (chap1Page === 2) {
    ...
    tint2553 -= 2
    fill(255, 255, 255, tint2553)
    text("Have fun suffering from protein \ndeficiency, loser.", width/3.95, height/1.66)
    ...
    if (timer > 8 && timer < 18) {
      bigtext()
      text("You wake up in a cold sweat.", width/3.95, height/1.66)
    }
  ...
  if (chap1Page === 3) {
    ...
    if (timer > 1){
      bigtext()
      text("You lay awake in bed anyways because \nyou’re nervous for the first shift.", width/3.95, height/1.66)
    }
  ...
  if (chap1Page === 4) {
    ...
    if (timer > 1){
      bigtext()
      text("Good choice. You put on your red \nuniform and get ready to face the day.", width/3.95, height/1.66)
    }
