...
///*
  if (chap1Page === 0) {
    ...
    if (timer > 4) {
      ...
      tint(255, tint01)
      imageMode(CENTER)
      image(peanut, width/2, 170, peanut.width/6, peanut.height/6)
    }
...
if (chap1Page === 18) {
  ...
  if (timer > 7) {
    bigtext()
    text("You and Noah rush to the kitchen.", 45, 370)
  }
  ...
  if (chap1Page === 25) {
    ...
    if (timer > 19 && timer < 25) {
      ...
      bigtext()
      fill(255, 255, 0)
      text("YOU GOT THE DRAGON KEY", 45, 370)
    }
