...
///*
  ...
  if (chap1Page === 11) {
    ...
    if (timer > 9 && timer < 18) {
      bigtext()
      text("You’re finally at Panda.", 50, 370)
    }
    ...
    if (chap1Page === 15) {
      ...
      if (timer > 17){
        ...
        if (optionOne === true) {
          ...
          bigtext()
          fill(255, 255, 0)
          text("- Definitely ", 50, 520)

          bigtext()
          text("- Nah, it's probably fine.", 50, 560)
  ...
  if (chap1Page === 16) {
    ...
    if (timer > 3 && timer < 8) {
      text("Well, this is mandatory so too bad.", 50, 410)
    }
